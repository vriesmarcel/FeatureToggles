...
namespace MvcMusicStore.Controllers
{
    public class FeatureTogglesController : BaseController
    {
        ...
        public async Task<ActionResult> Details(Guid? id)
        {
            ...
            Models.MVCFeatureToggle featureTogle = await db.FeatureToggles.FindAsync(id);
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Description, Enabled")] Models.MVCFeatureToggle featureToggle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Description, Enabled")] Models.MVCFeatureToggle featureToggle)
        {
            if (ModelState.IsValid)
            {
